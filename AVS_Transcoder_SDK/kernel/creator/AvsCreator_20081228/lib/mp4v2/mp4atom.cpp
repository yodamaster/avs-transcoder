...
MP4Atom* MP4Atom::CreateAtom(const char* type)
{
  ...
  if (type == NULL) {
    ...
    case 'a':
      if (ATOMID(type) == ATOMID("avs1")) {
	pAtom = new MP4Avs1Atom();
      } else if (ATOMID(type) == ATOMID("avs2")) {
	pAtom = new MP4Avs2Atom();
      }  else if (ATOMID(type) == ATOMID("avsc")) {
	pAtom = new MP4AvscAtom();
      } else if (ATOMID(type) == ATOMID("avss")) {
	pAtom = new MP4AvssAtom();
      } else if (ATOMID(type) == ATOMID("avsp")) {
	pAtom = new MP4AvspAtom();
