...
bool MP4AddH264PictureParameterSet(MP4FileHandle hFile,
				   ...
				   const uint8_t *pPict,
				   uint16_t pictLen);
MP4TrackId MP4AddAVSMVideoTrack(
								MP4FileHandle hFile,
								u_int32_t timeScale, 
								MP4Duration sampleDuration, 
								u_int16_t width, 
								...
								uint8_t sampleLenFieldSizeMinusOne);
bool MP4AddAVSMSequenceParameterSet(MP4FileHandle hFile,
									MP4TrackId trackId,
									const uint8_t *pSequence,
									uint16_t sequenceLen);
bool MP4AddAVSMPictureParameterSet(MP4FileHandle hFile,
								   MP4TrackId trackId,
								   const uint8_t *pPict,
								   uint16_t pictLen);
MP4TrackId MP4AddAVSVideoTrack(
								MP4FileHandle hFile,
								u_int32_t timeScale, 
								MP4Duration sampleDuration, 
								u_int16_t width, 
								...
								uint8_t sampleLenFieldSizeMinusOne);
bool MP4AddAVSSequenceHeader(MP4FileHandle hFile,
									MP4TrackId trackId,
									const uint8_t *pSequence,
									uint16_t sequenceLen);
...
/* AVS1 information routines */
bool MP4GetTrackAVSMProfileLevel(MP4FileHandle hFile,
				 MP4TrackId trackId,
				 uint8_t *pProfile,
				 uint8_t *pLevel);
bool MP4GetTrackAVSMSeqPictHeaders(MP4FileHandle hFile,
								   MP4TrackId trackId,
								   uint8_t ***pSeqHeaders,
								   uint32_t **pSeqHeaderSize,
								   uint8_t ***pPictHeader,
								   uint32_t **pPictHeaderSize);
bool MP4GetTrackAVSMLengthSize(MP4FileHandle hFile,
			       MP4TrackId trackId,
			       uint32_t *pLength);


/* AVS2 information routines */
bool MP4GetTrackAVSProfileLevel(MP4FileHandle hFile,
								 MP4TrackId trackId,
								 uint8_t *pProfile,
								 uint8_t *pLevel);
bool MP4GetTrackAVSSeqHeaders(MP4FileHandle hFile,
								   MP4TrackId trackId,
								   uint8_t ***pSeqHeaders,
								   uint32_t **pSeqHeaderSize);
bool MP4GetTrackAVSLengthSize(MP4FileHandle hFile,
							   MP4TrackId trackId,
							   uint32_t *pLength);
