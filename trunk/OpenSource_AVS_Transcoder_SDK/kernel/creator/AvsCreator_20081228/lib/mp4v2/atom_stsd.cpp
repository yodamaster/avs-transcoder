	...
	: MP4Atom("stsd") 
{
	...
	ExpectChildAtom("avc1", Optional, Many); // For H.264(AVC)
	ExpectChildAtom("avs1", Optional, Many); // For AVS-M
	ExpectChildAtom("avsp", Optional, Many);
	ExpectChildAtom("avs2", Optional, Many); // For AVS1-P2
}
