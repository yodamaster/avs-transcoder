...
class MP4Avs1Atom : public MP4Atom {
public:
	MP4Avs1Atom();
	void Generate();
};

class MP4AvspAtom : public MP4Atom {
public:
	MP4AvspAtom();
	void Generate();
};

class MP4AvscAtom : public MP4Atom {
public:
	MP4AvscAtom();
	void Generate();
};
...
class MP4Avs2Atom : public MP4Atom {
public:
	MP4Avs2Atom();
	void Generate();
};

class MP4AvssAtom : public MP4Atom {
public:
	MP4AvssAtom();
	void Generate();
};
