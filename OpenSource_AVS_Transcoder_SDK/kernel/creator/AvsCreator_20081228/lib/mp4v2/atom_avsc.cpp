	...
	: MP4Atom("avsc")
{
  ...
  AddProperty( new MP4Integer8Property("AvsmProfileIndication")); /* 1 */

  AddProperty( new MP4Integer8Property("AvsmLevelIndication")); /* 2 */
  ...
  pCount = new MP4BitfieldProperty("numOfSequenceParameterSets", 4);
...
void MP4AvscAtom::Generate()
{
	...
	((MP4BytesProperty*)m_pProperties[6])->
